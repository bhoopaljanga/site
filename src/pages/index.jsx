      ...
      <div className="container">
        <div className="row flex-lg-row-reverse align-items-center g-5 py-5">
          ...
          <div className="col-lg-6">
            <h1 className="display-5 text-crr fw-bold lh-sm mb-3">We Got All Your Accounting Needs Covered.</h1>
            <p className="lead">We are multidisciplinary team of accounting, tax and audit professionals with deep, sector-specific experience in wide spectrum of Industries.</p>
