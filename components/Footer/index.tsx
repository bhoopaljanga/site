        ...
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <div className="py-20 lg:py-25">
            <div className="flex flex-wrap gap-8 lg:justify-between lg:gap-0">
              ...
              <div className="flex w-full flex-col mt-10 gap-8 md:flex-row md:justify-between md:gap-0">

              {menuData.map((menuItem, key) => (
                menuItem.footer && menuItem.submenu &&
                 <motion.div
                  variants={{
                    hidden: {
                      opacity: 0,
...
Kavuri Hills, Hyderabad-500081</p>  
                ...
                <h4 className="mb-2 text-metatitle3 font-medium text-black dark:text-white">
                  Phone Number
                </h4>
                <p>
          ...
          <div className="flex flex-col flex-wrap items-center justify-center gap-5 border-t border-stroke py-7 dark:border-strokedark lg:flex-row lg:justify-between lg:gap-0">
            ...
            >
              <p>
                &copy; {new Date().getFullYear()} CRR Corporate Services. All rights reserved
              </p>
            </motion.div>
